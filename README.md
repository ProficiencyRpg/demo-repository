...
일반 상태 사망 시: 현재 숙련도 **(숙련도 별로 1%~10% 감소) / 최대 숙련도 (숙련도 별로 30%확률로 1 감소)** <br>
킬러 상태 사망 시: 현재 숙련도 **(숙련도 별로 10%~20% 감소) / 최대 숙련도 (무조건 2 감소)** <br>
또한 지갑에서 약간의 금액을 잃어버립니다.</br>

킬러 플레이어가 사망하여 아이템을 드롭하면 **다음과 같은 표에 의거한 확률로 아이템이 설정됩니다.**
확률|아이템에 대한 설정
:-------:|:-------:|
(40%)|회수상인(미정) 에게 돈이나 교환권을 내고 회수 (**아이템 회수가 가능하다는 동기 부여)**
(30%)|경매장에서 잃어버린 아이템 경매 **[아이템은 개수 단위가 아닌 칸 단위로 경매]**
(25%)|그 자리에서 즉시 아이템 드롭 **[아이템은 개수 단위가 아닌 칸 단위로 드롭]**
(5%)|그 자리에서 즉시 아이템 소멸 **[다시 얻을 수 없음]**
